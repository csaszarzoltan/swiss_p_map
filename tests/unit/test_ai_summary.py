...
async def test_ai_summary_gateway_mock_de() -> None:
        ...
        return httpx.Response(
            ...
            json={
                "choices": [
                    {
                        "message": {
                            "content": "In 8004 zahlst du 119% bei 62.5 dB (ÖV A). 2 Baugesuche offen — Muster Anna (SP) vertritt 4+5. (Quelle: api)"
                        }
                    }
                ]
            },
    ...
    async with httpx.AsyncClient(transport=transport) as client:
        ...
        txt = await svc.summarize(
            "de", "8004", {"postcode": "8004"}, {"district_name": "4+5"}, []
        )
