---
id: FEAT-038
title: Iskolák, Óvodák és Oktatási Ellátási Körzetek
status: SPEC_READY
version: 1
risk: high
owner: product-owner
...
# FEAT-038: Iskolák, Óvodák és Oktatási Ellátási Körzetek
...
- Kapcsolódó brief: `BRIEF-038` (`docs/briefs/BRIEF-038-iskolak-ovodak-es-ellatasi-korzetek.md`)
...
- REQ-001 [MUST]: A rendszer a iskolák, óvodák és oktatási ellátási körzetek hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a iskolák, óvodák és oktatási ellátási körzetek hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a iskolák, óvodák és oktatási ellátási körzetek hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a iskolák, óvodák és oktatási ellátási körzetek hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a iskolák, óvodák és oktatási ellátási körzetek hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Tervezett szerződés: `GET /api/v1/education/nearby?lat={lat}&lon={lon}`; `POST /api/v1/education/catchment`
