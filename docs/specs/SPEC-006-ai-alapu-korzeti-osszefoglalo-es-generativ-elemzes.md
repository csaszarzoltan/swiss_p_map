---
id: FEAT-006
title: AI-Alapú Körzeti Összefoglaló és Generatív Elemzés
status: SPEC_READY
version: 1
risk: medium
owner: product-owner
...
# FEAT-006: AI-Alapú Körzeti Összefoglaló és Generatív Elemzés
...
- Kapcsolódó brief: `BRIEF-006` (`docs/briefs/BRIEF-006-ai-alapu-korzeti-osszefoglalo-es-generativ-elemzes.md`)
- Kapcsolódó research: `docs/research/2026-08-27-ai-summary-live.md`
- Kapcsolódó ADR: `ADR-006` (`docs/decisions/ADR-006-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `src/services/ai_summary_service.py; src/main.py; frontend/src/app/[locale]/page.tsx`
...
- REQ-001 [MUST]: A rendszer a ai-alapú körzeti összefoglaló és generatív elemzés hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a ai-alapú körzeti összefoglaló és generatív elemzés hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a ai-alapú körzeti összefoglaló és generatív elemzés hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a ai-alapú körzeti összefoglaló és generatív elemzés hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a ai-alapú körzeti összefoglaló és generatív elemzés hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Szerződés: `POST /api/v1/ai/summary`
