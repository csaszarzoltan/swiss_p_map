---
id: FEAT-014
title: Többkantonos Építési Engedély Federáció
status: SPEC_READY
version: 1
risk: medium
owner: product-owner
...
# FEAT-014: Többkantonos Építési Engedély Federáció
...
- Kapcsolódó brief: `BRIEF-014` (`docs/briefs/BRIEF-014-tobbkantonos-epitesi-engedely-federacio.md`)
- Kapcsolódó research: `docs/research/2026-08-27-multi-canton-planning.md`
- Kapcsolódó ADR: `ADR-014` (`docs/decisions/ADR-014-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `src/services/planning_service.py; src/db/planning_repo.py`
...
- REQ-001 [MUST]: A rendszer a többkantonos építési engedély federáció hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a többkantonos építési engedély federáció hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a többkantonos építési engedély federáció hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a többkantonos építési engedély federáció hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a többkantonos építési engedély federáció hiányos vagy hibás adatát explicit állapotként jelzi
