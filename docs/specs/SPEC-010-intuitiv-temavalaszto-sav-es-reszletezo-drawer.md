---
id: FEAT-010
title: Intuitív Témaválasztó Sáv és Részletező Drawer
status: SPEC_READY
version: 1
risk: low
owner: product-owner
...
# FEAT-010: Intuitív Témaválasztó Sáv és Részletező Drawer
...
- Kapcsolódó brief: `BRIEF-010` (`docs/briefs/BRIEF-010-intuitiv-temavalaszto-sav-es-reszletezo-drawer.md`)
- Kapcsolódó research: `docs/research/2026-08-27-menu-detail-panel.md`
- Kapcsolódó ADR: `ADR-010` (`docs/decisions/ADR-010-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `frontend/src/components/TopicSidebar.tsx; frontend/src/components/DetailPanel.tsx; frontend/src/app/SearchPanel.tsx`
...
- REQ-001 [MUST]: A rendszer a intuitív témaválasztó sáv és részletező drawer hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a intuitív témaválasztó sáv és részletező drawer hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a intuitív témaválasztó sáv és részletező drawer hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a intuitív témaválasztó sáv és részletező drawer hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a intuitív témaválasztó sáv és részletező drawer hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Szerződés: Nincs új backend végpont; a komponensek a meglévő Place, Politics és Planning végpontokat használják.
