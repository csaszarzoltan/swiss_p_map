---
id: FEAT-012
title: Hivatalos BFS Népszavazási Adatfolyam
status: SPEC_READY
version: 1
risk: medium
owner: product-owner
...
# FEAT-012: Hivatalos BFS Népszavazási Adatfolyam
...
- Kapcsolódó brief: `BRIEF-012` (`docs/briefs/BRIEF-012-hivatalos-bfs-nepszavazasi-adatfolyam.md`)
- Kapcsolódó research: `docs/research/2026-08-27-bfs-vote-data.md`
- Kapcsolódó ADR: `ADR-012` (`docs/decisions/ADR-012-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `src/models/vote.py; src/services/vote_service.py; src/main.py`
...
- REQ-001 [MUST]: A rendszer a hivatalos bfs népszavazási adatfolyam hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a hivatalos bfs népszavazási adatfolyam hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a hivatalos bfs népszavazási adatfolyam hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a hivatalos bfs népszavazási adatfolyam hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a hivatalos bfs népszavazási adatfolyam hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Szerződés: `GET /api/v1/politics/votes/latest`
