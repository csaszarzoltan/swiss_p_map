---
id: FEAT-022
title: Építési Kockázatjelzés és „Miért?” Indoklás
status: SPEC_READY
version: 1
risk: medium
owner: product-owner
...
# FEAT-022: Építési Kockázatjelzés és „Miért?” Indoklás
...
- Kapcsolódó brief: `BRIEF-022` (`docs/briefs/BRIEF-022-epitesi-kockazatjelzes-es-indoklas.md`)
- Kapcsolódó research: `docs/research/2026-08-28-usability-deep-dive.md`
- Kapcsolódó ADR: `ADR-020` (`docs/decisions/ADR-020-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `frontend/src/components/RiskBadge.tsx; src/models/planning.py; src/models/place.py`
...
- REQ-001 [MUST]: A rendszer a építési kockázatjelzés és „miért?” indoklás hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a építési kockázatjelzés és „miért?” indoklás hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a építési kockázatjelzés és „miért?” indoklás hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a építési kockázatjelzés és „miért?” indoklás hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a építési kockázatjelzés és „miért?” indoklás hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Szerződés: A meglévő Place és Planning válaszok `risk_level` és `risk_reason` mezőit használja.
