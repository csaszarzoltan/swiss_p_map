---
id: FEAT-029
title: Adatforrás, Frissesség és Bizalmi Állapot
status: SPEC_READY
version: 1
risk: high
owner: product-owner
...
# FEAT-029: Adatforrás, Frissesség és Bizalmi Állapot
...
- Kapcsolódó brief: `BRIEF-029` (`docs/briefs/BRIEF-029-adatforras-frissesseg-es-bizalmi-allapot.md`)
...
- REQ-001 [MUST]: A rendszer a adatforrás, frissesség és bizalmi állapot hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a adatforrás, frissesség és bizalmi állapot hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a adatforrás, frissesség és bizalmi állapot hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a adatforrás, frissesség és bizalmi állapot hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a adatforrás, frissesség és bizalmi állapot hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Tervezett szerződés: A meglévő válaszmodellek egységes `provenance` objektummal bővülnek.
