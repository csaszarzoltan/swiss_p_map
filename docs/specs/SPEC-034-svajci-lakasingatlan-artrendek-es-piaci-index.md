---
id: FEAT-034
title: Svájci Lakásingatlan-Ártrendek és Piaci Index
status: SPEC_READY
version: 1
risk: high
owner: product-owner
...
# FEAT-034: Svájci Lakásingatlan-Ártrendek és Piaci Index
...
- Kapcsolódó brief: `BRIEF-034` (`docs/briefs/BRIEF-034-svajci-lakasingatlan-artrendek-es-piaci-index.md`)
...
- REQ-001 [MUST]: A rendszer a svájci lakásingatlan-ártrendek és piaci index hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a svájci lakásingatlan-ártrendek és piaci index hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a svájci lakásingatlan-ártrendek és piaci index hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a svájci lakásingatlan-ártrendek és piaci index hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a svájci lakásingatlan-ártrendek és piaci index hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Tervezett szerződés: `GET /api/v1/property-market/index?region={id}&type={house|apartment}`
