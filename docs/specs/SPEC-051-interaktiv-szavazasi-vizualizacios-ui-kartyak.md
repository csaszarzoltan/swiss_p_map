...
- REQ-051-001 [MUST]: A feature típusos, determinisztikus sikeres választ vagy UI-eredményt ad.
- REQ-051-002 [MUST]: Minden külső adat source, fetched_at és trust_state metaadatot tartalmaz.
- REQ-051-003 [MUST]: Loading, success, empty, stale/source_pending és error állapot támogatott.
- REQ-051-004 [MUST NOT]: Duplikált értesítés, hamis élő adat vagy hozzájárulás nélküli kézbesítés tilos.
- REQ-051-005 [ALWAYS]: A fallback nem jelenhet meg official_measurement státusszal.
- REQ-051-006 [CONCURRENCY]: Idempotency/deduplikáció és legutóbbi kérés nyer szabály kötelező.
## 4. Nem-funkcionális követelmények
- NFR-051-001 [PERFORMANCE]: UI feedback 100 ms; API timeout 10 s; connector cache a provider ciklusához kötött.
- NFR-051-002 [ACCESSIBILITY]: WCAG 2.1 AA, billentyűzet, aria-live, grafikonhoz szöveges alternatíva.
- NFR-051-003 [PRIVACY]: nDSG/GDPR minimalizálás; email/push token titkos vagy hash-elt tárolása.
## 5. Elfogadási kritériumok
### AC-051-001: Happy path
...
### AC-051-003: Hibás vagy ismételt kérés
...
`Frontend-only VotingVisualCard consuming vote analysis APIs`. JSON response source/trust/cache metaadatokkal; írások idempotency mezővel.
...
## 11. Nemzetköziesítés
DE/EN/FR/IT kulcsnévtér: `phase3.feature051.*`.
## 12. Akadálymentesség
...
- REQ-051-001 -> AC-051-001 -> unit + API/E2E.
- REQ-051-002 -> AC-051-001 -> contract test.
- REQ-051-003 -> AC-051-001..003 -> UI state test.
- REQ-051-004 -> AC-051-003 -> negative/dedup test.
- REQ-051-005 -> AC-051-002 -> fallback test.
- REQ-051-006 -> AC-051-003 -> concurrency/idempotency test.
