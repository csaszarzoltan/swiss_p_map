---
id: FEAT-001
title: Svájci Térinformatikai Architektúra és Stack
status: SPEC_READY
version: 1
risk: low
owner: product-owner
...
# FEAT-001: Svájci Térinformatikai Architektúra és Stack
...
- Kapcsolódó brief: `BRIEF-001` (`docs/briefs/BRIEF-001-svajci-terinformatikai-architektura.md`)
- Kapcsolódó research: `docs/research/2026-08-26-kickoff.md`
- Kapcsolódó ADR: `ADR-001` (`docs/decisions/ADR-001-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `src/main.py; src/services/geo_converter.py; src/models/geo.py`
...
- REQ-001 [MUST]: A rendszer a svájci térinformatikai architektúra és stack hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a svájci térinformatikai architektúra és stack hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a svájci térinformatikai architektúra és stack hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a svájci térinformatikai architektúra és stack hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a svájci térinformatikai architektúra és stack hiányos vagy hibás adatát explicit állapotként jelzi
...
## 11. API-szerződés
- Szerződés: `GET /api/v1/geo/convert?easting={float}&northing={float}`
