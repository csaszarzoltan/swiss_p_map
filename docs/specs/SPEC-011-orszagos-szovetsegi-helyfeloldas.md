---
id: FEAT-011
title: Országos Szövetségi Helyfeloldás
status: SPEC_READY
version: 1
risk: low
owner: product-owner
...
# FEAT-011: Országos Szövetségi Helyfeloldás
...
- Kapcsolódó brief: `BRIEF-011` (`docs/briefs/BRIEF-011-orszagos-szovetsegi-helyfeloldas.md`)
- Kapcsolódó research: `docs/research/2026-08-27-federal-place-expansion.md`
- Kapcsolódó ADR: `ADR-011` (`docs/decisions/ADR-011-*.md`)
...
- Implementációs bizonyíték / tervezett érintettség: `src/services/swisstopo_service.py; src/services/place_service.py`
...
- REQ-001 [MUST]: A rendszer a országos szövetségi helyfeloldás hiányos vagy hibás adatát explicit állapotként jelzi. A művelet sikerét a felületen és az API-válaszban azonos domainállapot reprezentálja.
- REQ-002 [MUST]: A rendszer a országos szövetségi helyfeloldás hiányos vagy hibás adatát explicit állapotként jelzi. Minden megjelenített értékhez típus, mértékegység és forrás tartozik, ha az érték adatforrásból ered.
- REQ-003 [MUST]: A rendszer a országos szövetségi helyfeloldás hiányos vagy hibás adatát explicit állapotként jelzi. Hiányzó, részleges vagy alacsony felbontású adatot a rendszer explicit `unavailable`, `estimated` vagy `fallback` állapottal jelöl.
- REQ-004 [MUST]: A rendszer a országos szövetségi helyfeloldás hiányos vagy hibás adatát explicit állapotként jelzi. Az elsődleges művelet egér, érintés és billentyűzet használatával is végrehajtható.
...
When a rendszer a országos szövetségi helyfeloldás hiányos vagy hibás adatát explicit állapotként jelzi
