...
class MicroclimateService:
    def assess(self, postcode: str, canton: str) -> MicroclimateAssessment:
        ...
        return MicroclimateAssessment(postcode=postcode,canton=canton.upper(),summer_heat_island_c=urban,current_tropical_nights_per_year=current,scenarios=[ClimateScenario(warming_level_c="1.5",tropical_nights_per_year=current+8),ClimateScenario(warming_level_c="3.0",tropical_nights_per_year=current+24)])
