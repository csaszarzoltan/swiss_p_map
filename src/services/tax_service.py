...
_RATES: dict[str, float] = {
    "ZH": 119.0, "BE": 154.0, "LU": 116.0, "UR": 100.0, "SZ": 60.0, "OW": 85.0,
    "NW": 65.0, "GL": 118.0, "ZG": 54.0, "FR": 138.0, "SO": 125.0, "BS": 145.0,
    "BL": 132.0, "SH": 112.0, "AR": 104.0, "AI": 96.0, "SG": 124.0, "GR": 108.0,
    "AG": 112.0, "TG": 117.0, "TI": 120.0, "VD": 150.0, "VS": 130.0, "NE": 156.0,
    "GE": 155.0, "JU": 157.0,
}
_NEIGHBORS: dict[str, list[str]] = {
    "ZH": ["AG", "SH", "TG", "SZ", "ZG"], "BE": ["FR", "JU", "LU", "NE", "SO", "VD", "VS"],
    "ZG": ["ZH", "SZ", "LU"], "SZ": ["ZG", "ZH", "LU", "UR", "GL"],
}
...
class TaxService:
    ...
    def compare(self, canton: str) -> TaxComparison | None:
        ...
        ranking = [TaxEntry(canton=c, steuerfuss_percent=v, national_rank=i, band=_band(v)) for i, (c, v) in enumerate(ordered, 1)]
        ...
        return TaxComparison(
            ...
            selected=by_code[code], ranking=ranking, neighboring_cantons=neighbors,
        )
