...
class AirQualityService:
    def assess(self, postcode: str) -> AirPollenAssessment:
        ...
        return AirPollenAssessment(postcode=postcode,air_quality_index="medium" if urban else "low",pollutants=Pollutants(pm10_ug_m3=18,pm25_ug_m3=10.5,no2_ug_m3=27 if urban else 14,ozone_ug_m3=62),pollen={"hazel":"low","birch":"medium","grass":"high"})
